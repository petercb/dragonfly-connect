...
A lightweight Bedrock Edition proxy that allows players to connect to various
servers from a central menu, built using the Dragonfly server library.
...
2. **Menu**: Player is immediately presented with a Bedrock form menu showing
   available servers.
